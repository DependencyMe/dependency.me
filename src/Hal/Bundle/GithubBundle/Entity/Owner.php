 ...
 class Owner implements OwnerInterface, UserInterface
{
     ...
     * Add repositories
     *
     * @param \Hal\Bundle\GithubBundle\Entity\Repository $repositories
     * @return Owner
     */
    public function addRepository(\Hal\Bundle\GithubBundle\Entity\Repository $repositories)
    {
     ...
     * @param \Hal\Bundle\GithubBundle\Entity\Repository $repositories
     */
    public function removeRepository(\Hal\Bundle\GithubBundle\Entity\Repository $repositories)
    {
     ...
     * @return Owner
     */
    public function addRepositorie(\Hal\Bundle\GithubBundle\Entity\Repository $repositories)
    {
        $this->repositories[] = $repositories;
     ...
     * @param \Hal\Bundle\GithubBundle\Entity\Repository $repositories
     */
    public function removeRepositorie(\Hal\Bundle\GithubBundle\Entity\Repository $repositories)
    {
        $this->repositories->removeElement($repositories);
    }
     /**
